                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                <!-- Copyright Left -->
                                <div class="copyright-left">&copy; Copyrights 2022 SharePosts All rights reserved.</div>
                                <!-- Copyright Right -->
                                <div class="copyright-right">Made with <i class="fas fa-heart"></i> By <a href="#">Vera Nwoye</a></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?php echo URLROOT;?>/jquery/jquery.min.js"></script>
<script src="<?php echo URLROOT;?>/js/popper.min.js"></script>
<script src="<?php echo URLROOT;?>/js/bootstrap.min.js"></script>
<script src="<?php echo URLROOT;?>/js/bootstrap.min.js"></script>
<script src="<?php echo URLROOT;?>/plugins/plugins.min.js"></script>
<script src="<?php echo URLROOT;?>/js/active.js"></script>
